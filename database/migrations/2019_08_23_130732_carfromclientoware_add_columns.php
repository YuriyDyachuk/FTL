...
class CarfromclientowareAddColumns extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('car_request_pull_cargo_from_client_to_our_warehouse', function(Blueprint $table){
            $table->boolean('forwarding_enabled')->nullable()->comment('Экспедирование (пересчёт мест/фото отчёт/схема погрузки/акт погрузки)');
