 ...
 */
class ClientRequestFtlwhTo extends Model
{
    /**
     ...
     * @var string
     */
    protected $table = 'client_request_ftlwh_to';
    ...
    {
        return $this->belongsTo('App\Models\Entities\ClientRequests');
    }
}
