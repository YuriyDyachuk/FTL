<script id="clRqstFromTemplate" type="text/html">
    <div style="position: relative;" class="wrapper_block clientrequest-from-form-wrapper mb-5 mt-5" data-i="@{{:i}}">
        <a href="#" class="untie-clrqstfrom_form-js pull-right btn btn-danger">-</a>

        <input type="hidden" class="form-control" name="clientrequest[{{$fromto}}][@{{:i}}][city]">


        <div class="form-group row">
            <label class="col-lg-4 col-form-label">Пункт A@{{:i+1}}</label>
            <div class="col-lg-8">
                <select name="clientrequest[{{$fromto}}][@{{:i}}][type]" class="from_select form-control fromtype_select" data-fromto="{{$fromto}}">
                    <option value=""></option>
