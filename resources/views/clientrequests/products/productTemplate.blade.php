<script id="productTemplate" type="text/html">
        <div style="position: relative;" class="product-form-wrapper" data-i="@{{:id}}">
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                        <input name="product[@{{:id}}][from_warehouse_cargo]" type="hidden">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                <input type="hidden" name="product[@{{:id}}][status]" value="{{ \App\Models\Entities\GettingActCargo::IN_THE_WAREHOUSE_STATUS }}">
{{--                                <input class="uid_input" type="hidden" name="product[@{{:id}}][uid]" value="">--}}
                                <div class="col-6">
                                ...
                                <div class="col-3 form-group field-productform-@{{:id}}-weight">
                                    ...
                                    <input type="text" class="form-control cargo_amount goods_weight" name="product[@{{:id}}][weight]" id="productform-@{{:id}}-weight">
                                    <div class="help-block"></div>
                                </div>
                                <div class="col-3 form-group field-productform-@{{:id}}-volume">
                                    ...
                                    <input type="text" class="form-control cargo_amount goods_volume" name="product[@{{:id}}][volume]" id="productform-@{{:id}}-volume">
                                    <div class="help-block"></div>
                                </div>
                            </div>
                        </div>
