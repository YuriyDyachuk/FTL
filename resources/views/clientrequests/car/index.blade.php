...
@section('title', 'FTL: Авто Клиентские Заявки')

@section('content_header')
    Авто Клиентские Заявки @include('partials.title', ['text' => App\Title::get()['ordersIndex']['clientRequest']])
@stop
    ...
    <div class="">
        <div class="kt-portlet__body">
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-2">
                        @include('clientrequests.car._filter')
                    </div>
                    <div class="col-md-10">
                        <div class="">
                            <table class="table table-hover table-striped">
                                ...
                                @foreach($entities as $entity)
                                    <tr onclick="location.href ='{{route('clientrequests.car.edit', ['client' => $entity])}}'">
