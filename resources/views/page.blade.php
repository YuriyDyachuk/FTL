            ...
            <div class="kt-aside    kt-grid__item kt-grid kt-grid--desktop kt-grid--hor-desktop" id="kt_aside">
                ...
                <div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
                    <div id="kt_aside_menu" class="kt-aside-menu  kt-aside-menu--dropdown " data-ktmenu-vertical="1" data-ktmenu-dropdown="1" data-ktmenu-scroll="0">
                        {{ App\Models\Helpers\MenuHelper::buildMenu($sidebarMenu) }}
                    </div>
                </div>
...
{{--                                    <span class="kt-menu__link-text"><b>CRM FTL 8020 </b>v 1.7.6.5</span>--}}
{{--                                </li>--}}
{{--                            </ul>--}}
{{--                        </div>--}}
{{--                    </div>--}}
...
{{--                                    <span class="kt-badge kt-badge--username kt-badge--unified-success kt-badge--lg kt-badge--rounded kt-badge--bolder">{{ mb_substr($userManager->getName(), 0, 1) }}</span>--}}
{{--                                </div>--}}
{{--                            </div>--}}
...
{{--                </div>--}}
                ...
                <div class="kt-header kt-grid__item p-2 mb-5">
                    <div class="container-fluid">
                        @include('partials.managerInfo')
                    </div>
                </div>
                ...
                <div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
                    ...
                    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
                        <div class="kt-portlet">
                            <div class="kt-subheader  kt-grid__item mb-0" id="kt_subheader">
                                <div class="kt-container  kt-container--fluid ml-3">
                ...
                <div class="kt-footer  kt-grid__item kt-grid kt-grid--desktop kt-grid--ver-desktop" id="kt_footer">
                    <div class="kt-container  kt-container--fluid ">
                        <div class="kt-footer__copyright">
                            2019-{{date('Y')}} © <a href="/" class="kt-link"><b> FTL EMS 8020 </b>v 1.10.2.1</a>
                        </div>
